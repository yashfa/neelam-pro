 ...
 * PHP Version 5
 * @package PHPMailer
 * @link https://github.com//Content/phpMailer//Content/phpMailer/ The PHPMailer GitHub project
    ...
    public function createHeader()
    {
        ...
        if ($this->XMailer == '') {
            $result .= $this->headerLine(
                'X-Mailer',
                'PHPMailer ' . $this->Version . ' (https://github.com//Content/phpMailer//Content/phpMailer/)'
            );
        } else {
